    ...
    return(
        <Grid container className={classes.containerRoot}>
            <Grid container className={classes.container}>
                ...
                <Container maxWidth="sm" style={{ backgroundColor: 'white', borderRadius: 15, paddingBottom: 20 }}>
                    <Grid container spacing={4} className={classes.containerForm}>
                        <label className={classes.titulo1}>Doador</label>
                        ...
                        <Grid item xs={12} style={{ display: 'flex', justifyContent: 'center' }}>
                            <FavoriteIcon style={{color:"#E53935" }} /> <strong style={{ paddingTop: 3, color: 'black' }}>10</strong>
                        </Grid>

                        <Grid item xs={12} className={classes.formField}>
                            <TextField disabled fullWidth required value={name} label="Nome Completo" />
                        </Grid>
                        <Grid item xs={12} className={classes.formField}>
